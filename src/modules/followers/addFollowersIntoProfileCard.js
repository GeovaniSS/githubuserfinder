...
const addFollowersIntoProfileCard = async(gitHubUserFollowers) => {
  const followersPromises = generateFollowersPromises(gitHubUserFollowers)
...
export default addFollowersIntoProfileCard